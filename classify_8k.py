...
def classify_8k_filing(
    input_source: str, strategy: PromptStrategy = PromptStrategy.DETAILED, verbose: bool = False
) -> Optional[dict]:
    """
...
Examples:
  ...
  python classify_8k.py "https://www.sec.gov/Archives/edgar/data/320193/000032019324000005/aapl-20240201.htm" --strategy cot
    ...
    parser.add_argument(
        "--list-files", action="store_true", help="List available 8-K files and exit"
    )
