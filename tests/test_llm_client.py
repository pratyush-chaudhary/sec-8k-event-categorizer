...
class TestLLMClient(unittest.TestCase):
    ...
    def test_client_with_config_file(self):
        ...
        try:
            ...
            print(f"✓ Client loaded from config file: {model_info['provider']} - {model_info['model']}")
    ...
    def test_client_with_default_config(self):
        ...
        print(f"✓ Client initialized with defaults: {model_info['provider']} - {model_info['model']}")
